...
- Brand marks use `assets/logo-horizontal.svg` on dark horizontal surfaces. The integration hub uses the self-contained `assets/vertical.svg` without an added container background; never reconstruct either mark with live text or a separate lamp.
